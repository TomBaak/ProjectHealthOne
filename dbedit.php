        ...
        switch ($master) {
            ...
            case "pat":
                ...
                switch ($_POST['type']) {
                    ...
                    case "new":
                        $query = $db->prepare("INSERT INTO `patienten`(`naam`, `dob`, `vernum`, `telefoon`, `email`, `artsid`, `adres`) VALUES (:naam,:dob,NULL,:telnum,:email,:artsid,:adres)");
            ...
            case "arts":
                if (!isset($_GET['type'])) {
                    ...
                    switch ($_POST['type']) {
                        ...
                        case 'edit':
                            $id = $_POST['id'];
                            $query = $db->prepare('UPDATE `artsen` SET `naam`=:naam WHERE id=' . $id);
                            $query->bindParam("naam", $naam);
                            break;
                    };
